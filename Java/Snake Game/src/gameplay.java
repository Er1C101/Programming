...
public class gameplay extends JPanel implements KeyListener, ActionListener {
	...
	private boolean pastSpace = false;
	...
	public void playingSpace(Graphics g) {
		...
		if(playingSpace) {
			...
			g.drawString("You pressed \"Space\" while still playing,", 250, 300);
			g.drawString("you can continue playing by pressing any of the arrow keys.", 160, 340);
			g.drawString("Press CTRL + Space To Restart", 275, 380);
		}
